...
+ (void)createAUPresetFromDict:(NSDictionary * _Nonnull)dict path:(NSString * _Nonnull)path instName:(NSString * _Nonnull)instName;
...
- (nonnull instancetype)init:(AKNode * _Nonnull)input time:(double)time maximumDelayTime:(double)maximumDelayTime OBJC_DESIGNATED_INITIALIZER;
